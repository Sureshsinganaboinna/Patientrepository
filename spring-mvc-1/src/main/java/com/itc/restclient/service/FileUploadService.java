...
public class FileUploadService {
	...
	public void fileUpload(MultipartFile inputFile) throws Exception
	{
		...
		Boolean isAllowedFileType = Arrays.stream(allowedFileExtensions).anyMatch(extension -> filenameextension.equals(extension) );
				//Arrays.stream(allowedFileExtensions).anyMatch(filenameextension::equals);
